...
def on_message(ws, message):
    try:
        ...
        if stepName == "job-opportunities":
            ...
            employmentType = get_data().get("employmentType")
...
def connect(applicationId, jobId, scheduleId, jobDetails: dict):
    accessToken = get_data().get("accessToken")
    auth_token = quote(accessToken, safe='')
    candidateId = get_data().get("candidateId")
    set_application_data(applicationId, jobId, scheduleId, jobDetails.get("state"), jobDetails.get("employmentType"))
